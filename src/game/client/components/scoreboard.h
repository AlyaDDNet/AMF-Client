...
class CScoreboard : public CComponent
{
	...
	ColorRGBA WithRenderAlpha(ColorRGBA Color) const { return Color.WithMultipliedAlpha(m_SmoothHudRenderAlpha); }

	bool m_Active;
	float m_SmoothHudOpenProgress = 0.0f;
	float m_SmoothHudOffsetY = 0.0f;
	float m_SmoothHudRenderAlpha = 0.0f;
	bool m_SmoothHudTargetActive = false;
	...
	float GetPopupWidth(int ClientId, bool IsLocal, bool IsSpectating) const;
	...
	public:
		...
		CButtonContainer m_BlockButton;
		CButtonContainer m_TeamMuteButton;
