...
#ifndef GAME_CLIENT_COMPONENTS_TCLIENT_MUSIC_PLAYER_H
#define GAME_CLIENT_COMPONENTS_TCLIENT_MUSIC_PLAYER_H
...
public:
	...
	// Shared layout-only path for the editor when the runtime renderer has no
	// visible frame (for example while the module is disabled).
	CUIRect GetHudDefaultRect() const;
