...
#ifndef GAME_CLIENT_COMPONENTS_TCLIENT_CLOUD_INPUT_H
#define GAME_CLIENT_COMPONENTS_TCLIENT_CLOUD_INPUT_H
...
// Cloud Input predicts the locally supplied player input ahead by a configurable
// fraction of a game tick. Text input remains on DDNet's regular line-input path.
