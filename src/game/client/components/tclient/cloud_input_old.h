...
#ifndef GAME_CLIENT_COMPONENTS_TCLIENT_CLOUD_INPUT_OLD_H
#define GAME_CLIENT_COMPONENTS_TCLIENT_CLOUD_INPUT_OLD_H
...
// The legacy Cloud Input implementation retained as a separate AMF mode.
// Its state is intentionally independent from CCloudInput (the current mode).
class CCloudInputOld : public CComponent
{
public:
