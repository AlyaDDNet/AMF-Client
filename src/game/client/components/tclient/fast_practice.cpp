...
void CFastPractice::TickPracticeWorld()
{
	...
	const int FastInputTicks = CloudInputMode ? GameClient()->m_CloudInput.SelfTickOffset() : TClientInputs::PredictionTicks(FastInputOffsetTicks);
	const int FastInputOthersTicks = CloudInputMode ? GameClient()->m_CloudInput.OthersTickOffset() : (TClientInputs::AnyOthers() ? TClientInputs::PredictionTicksOthers(FastInputOffsetTicks) : 0);
