...
void CMenusSettingsControls::OnInterfacesInit(CGameClient *pClient)
{
	...
	m_vBindOptions = {
		...
		{EBindOptionGroup::AMF_CLIENT_PRACTICE, Localizable("say /r"), "say /r"},
		{EBindOptionGroup::AMF_CLIENT_PRACTICE, Localizable("say /invincible"), "say /invincible"},
		{EBindOptionGroup::AMF_CLIENT_PRACTICE, Localizable("say /telecursor"), "say /telecursor"},
		{EBindOptionGroup::AMF_CLIENT_PRACTICE, Localizable("say /weapons"), "say /weapons"},
		{EBindOptionGroup::AMF_CLIENT_PRACTICE, Localizable("say /unweapons"), "say /unweapons"},
...
void CMenusSettingsControls::Render(CUIRect MainView)
{
	...
	RenderSettingsBindsBlock(EBindOptionGroup::AMF_CLIENT_PRACTICE, &RightColumn, Localize("AMF Client Practice"));
