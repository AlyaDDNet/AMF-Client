...
class CHud : public CComponent
{
	...
	HudLayout::SModuleRect m_GameTimerBounds{};
	HudLayout::SModuleRect m_DummyActionsBounds{};
	float m_AmfKeyIndicatorVisibility = 0.0f;
	int64_t m_aaAmfKeyIndicatorClickTimes[2][32] = {};
	int m_aAmfKeyIndicatorClickTimeOffsets[2] = {};
	bool m_aAmfKeyIndicatorMousePressed[2] = {};
	int m_aAmfKeyIndicatorCps[2] = {};
	IGraphics::CTextureHandle m_AmfMouseIndicatorTexture;
	IGraphics::CTextureHandle m_AmfMouseIndicatorWhiteTexture;
	int64_t m_AmfMouseIndicatorMouse1EndTime = 0;
	int64_t m_AmfMouseIndicatorWheelUpEndTime = 0;
	int64_t m_AmfMouseIndicatorWheelDownEndTime = 0;
	...
	void RenderAmfKeyIndicator();
	void RenderAmfMouseIndicator();
	int GetAmfMouseIndicatorTrackedClientId() const;
	const CNetObj_PlayerInput *GetAmfMouseIndicatorTrackedInput() const;
	bool GetAmfMouseIndicatorTrackedAim(int TrackedClientId, float Intra, vec2 &OutAim) const;
...
public:
	...
	// These are the exact screen-space bounds used by the corresponding renderers.
	// The HUD editor consumes them directly, so its selection/drag bounds can never
	// diverge from the visible HUD element.
	HudLayout::SModuleRect GetAmfKeyIndicatorBounds() const;
	HudLayout::SModuleRect GetAmfMouseIndicatorBounds() const;
	HudLayout::SModuleRect GetLocalTimeBounds() const;
	HudLayout::SModuleRect GetGameTimerBounds() const { return m_GameTimerBounds; }
	HudLayout::SModuleRect GetDummyActionsBounds() const { return m_DummyActionsBounds; }
	HudLayout::SModuleRect GetPredictionTimeBounds() const { return m_PredictionTimeBounds; }
	HudLayout::SModuleRect GetMovementInformationBounds() const { return m_MovementInformationBounds; }
	HudLayout::SModuleRect GetScoreHudBounds() const { return m_ScoreHudBounds; }
	HudLayout::SModuleRect GetPlayerStateBounds() const { return m_PlayerStateBounds; }
	HudLayout::SModuleRect GetRemainingPlayersBounds() const { return m_RemainingPlayersBounds; }
...
private:
	...
	HudLayout::SModuleRect m_PredictionTimeBounds{};
	HudLayout::SModuleRect m_MovementInformationBounds{};
	HudLayout::SModuleRect m_ScoreHudBounds{};
	HudLayout::SModuleRect m_PlayerStateBounds{};
	HudLayout::SModuleRect m_RemainingPlayersBounds{};
	float m_ScoreHudLastRight = -1.0f;
	float m_ScoreHudLastTop = -1.0f;
	int m_aScoreHudLastCorners[2] = {-1, -1};
