...
void CGameClient::OnPredict()
{
	...
	const int FastInputTicks = CloudInputMode ? m_CloudInput.SelfTickOffset() : TClientInputs::PredictionTicks(FastInputOffsetTicks);
	const bool FastInputOthers = CloudInputMode ? (g_Config.m_AmfCloudInputOthers != 0 && m_ReceivedPreInput) : TClientInputs::AnyOthers();
	const int FastInputTicksOthers = CloudInputMode ? (FastInputOthers ? m_CloudInput.OthersTickOffset() : 0) : (FastInputOthers ? TClientInputs::PredictionTicksOthers(FastInputOffsetTicks) : 0);
...
void CGameClient::UpdateRenderedCharacters()
{
	...
	const int FastInputTicks = CloudInputMode ? m_CloudInput.SelfTickOffset() : TClientInputs::PredictionTicks(FastInputOffsetTicks);
	const bool FastInputOthers = CloudInputMode ? (g_Config.m_AmfCloudInputOthers != 0 && m_ReceivedPreInput) : TClientInputs::AnyOthers();
	const int FastInputTicksOthers = CloudInputMode ? (FastInputOthers ? m_CloudInput.OthersTickOffset() : 0) : TClientInputs::PredictionTicksOthers(FastInputOffsetTicks);
