...
void CCharacter::HandleTiles(int Index)
{
	...
	// The regular client prediction intentionally does not process teleports.
	// Fast Practice enables this flag for its private world, where we mirror the
	// authoritative DDNet tile semantics (including super/invincible restrictions).
