...
public:
	...
	void Reset()
	{
		...
		m_OriginalBodyColor = ColorRGBA(1.0f, 1.0f, 1.0f, 1.0f);
		m_OriginalFeetColor = ColorRGBA(1.0f, 1.0f, 1.0f, 1.0f);
	...
	void Apply(const CSkin *pSkin)
	{
		...
		m_OriginalBodyColor = pSkin->m_OriginalBodyColor;
		m_OriginalFeetColor = pSkin->m_OriginalFeetColor;
	...
	void ApplySkin(const CTeeRenderInfo &TeeRenderInfo)
	{
		...
		m_OriginalBodyColor = TeeRenderInfo.m_OriginalBodyColor;
		m_OriginalFeetColor = TeeRenderInfo.m_OriginalFeetColor;
	...
	ColorRGBA m_OriginalBodyColor;
	ColorRGBA m_OriginalFeetColor;
	...
	public:
		void Reset()
		{
			...
			std::fill(std::begin(m_aOriginalColors), std::end(m_aOriginalColors), ColorRGBA(1.0f, 1.0f, 1.0f, 1.0f));
			m_BloodColor = ColorRGBA(1.0f, 1.0f, 1.0f, 1.0f);
		...
		ColorRGBA m_aOriginalColors[protocol7::NUM_SKINPARTS];
		ColorRGBA m_BloodColor;
