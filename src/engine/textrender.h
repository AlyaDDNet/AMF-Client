...
public:
	...
	// Keep cursor-position calculation while allowing a caller to render a
	// replacement caret (used by the optional AMF chat caret animation).
	bool m_HideCursorRendering = false;
