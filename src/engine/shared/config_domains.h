...
CONFIG_DOMAIN(AMFCLIENT, "settings_amfclient.cfg", true)
CONFIG_DOMAIN(AMFHUDLAYOUT, "amf_hud_layout.cfg", false)
CONFIG_DOMAIN(AMFASSETLAYOUT, "amf_asset_layout.cfg", false)
